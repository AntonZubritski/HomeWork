...
class App {
    ...
    _renderRow(rowData) {
        ...
        row.appendChild(this._generateTd(rowData.name));
        row.appendChild(this._generateTd(rowData.cost));
        row.appendChild(this._generateTd(rowData.img));
        row.appendChild(this._generateTd(rowData.stat));
...
const obj = new App(gdgdf, sdfsdf, sdfsdf)
...
console.log("testObject", testObject.tellMeYourName());